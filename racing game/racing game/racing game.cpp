// racing game.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include <string>
#include <iostream>
using namespace std;

#include "C:/Users/hp1/Downloads/olcConsoleGameEngine.h"
...
protected:
    ...
    virtual bool OnUserUpdate(float fElapsedTime)
    {
        ...
        float fTrargetCurvature = vecTrack[nTrackSection - 1].first;

        float fTrackCurveDiff = (fTrargetCurvature - fCurvature) * fElapsedTime * fSpeed;
        ...
        for (int y = 0; y < ScreenHeight() / 2; y++)
        {
            for (int x = 0; x < ScreenWidth(); x++)
            {
                float fPerspective = (float)y / ScreenHeight() / 0.4f;
